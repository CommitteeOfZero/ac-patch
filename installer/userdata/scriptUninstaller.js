...
function DoTx() {
  ...
  // Remove modified ressources

  //Inside windata/movie
  if (!ng.fs.global().pathIsFile('%GAME_PATH%/windata/movie/op_en.mzv')) {
    applyPatchesSection.copyFiles('%GAME_PATH%/windata/movie/op_en_original.mzv', '%GAME_PATH%/windata/movie/op_en.mzv');
  }

  if (!ng.fs.global().pathIsFile('%GAME_PATH%/windata/movie/op_silent.mzv')) {
    applyPatchesSection.copyFiles('%GAME_PATH%/windata/movie/op_silent_original.mzv', '%GAME_PATH%/windata/movie/op_silent.mzv');
  }

  if (!ng.fs.global().pathIsFile('%GAME_PATH%/windata/movie/op.mzv')) {
    applyPatchesSection.copyFiles('%GAME_PATH%/windata/movie/op_original.mzv', '%GAME_PATH%/windata/movie/op.mzv');
  }

  if (!ng.fs.global().pathIsFile('%GAME_PATH%/windata/movie/normal_end.mzv')) {
    applyPatchesSection.copyFiles('%GAME_PATH%/windata/movie/normal_end_original.mzv', '%GAME_PATH%/windata/movie/normal_end.mzv');
  }

  if (!ng.fs.global().pathIsFile('%GAME_PATH%/windata/movie/true_end.mzv')) {
    applyPatchesSection.copyFiles('%GAME_PATH%/windata/movie/true_end_original.mzv', '%GAME_PATH%/windata/movie/true_end.mzv');
  }
  
  //Inside windata
  //Config
  if (ng.fs.global().pathIsFile('%GAME_PATH%/windata/config_body.bin')) {
    section.removeFile('%GAME_PATH%/windata/config_body.bin');
    section.copyFiles('%GAME_PATH%/windata/config_body_original.bin', '%GAME_PATH%/windata/config_body.bin');
  }

  if (ng.fs.global().pathIsFile('%GAME_PATH%/windata/config_info.psb.m')) {
    section.removeFile('%GAME_PATH%/windata/config_info.psb.m');
    section.copyFiles('%GAME_PATH%/windata/config_info_original.psb.m', '%GAME_PATH%/windata/config_info.psb.m');
  }

  //Font
  if (ng.fs.global().pathIsFile('%GAME_PATH%/windata/font_body.bin')) {
    section.removeFile('%GAME_PATH%/windata/font_body.bin');
    section.copyFiles('%GAME_PATH%/windata/font_body_original.bin', '%GAME_PATH%/windata/font_body.bin');
  }

  if (ng.fs.global().pathIsFile('%GAME_PATH%/windata/font_info.psb.m')) {
    section.removeFile('%GAME_PATH%/windata/font_info.psb.m');
    section.copyFiles('%GAME_PATH%/windata/font_info_original.psb.m', '%GAME_PATH%/windata/font_info.psb.m');
  }

  //Script
  if (ng.fs.global().pathIsFile('%GAME_PATH%/windata/script_body.bin')) {
    section.removeFile('%GAME_PATH%/windata/script_body.bin');
    section.copyFiles('%GAME_PATH%/windata/script_body_original.bin', '%GAME_PATH%/windata/script_body.bin');
  }

  if (ng.fs.global().pathIsFile('%GAME_PATH%/windata/script_info.psb.m')) {
    section.removeFile('%GAME_PATH%/windata/script_info.psb.m');
    section.copyFiles('%GAME_PATH%/windata/script_info_original.psb.m', '%GAME_PATH%/windata/script_info.psb.m');
  }

  // Remove c0_subs_disabled.nut
  if (ng.fs.global().pathIsFile('%GAME_PATH%/c0_subs_disabled.nut')) {
    section.removeFile('%GAME_PATH%/c0_subs_disabled.nut');
  }

  // Remove our launcher
  if (ng.fs.global().pathIsFile('%GAME_PATH%/MAGESgamelauncher.exe')) {
    section.removeFile('%GAME_PATH%/MAGESgamelauncher.exe');
    section.copyFiles('%GAME_PATH%/MAGESgamelauncher_original.exe', '%GAME_PATH%/MAGESgamelauncher.exe');
  }
